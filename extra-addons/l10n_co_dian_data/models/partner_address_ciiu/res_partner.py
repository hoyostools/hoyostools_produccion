...
class ResPartner(models.Model):
    ...
    @api.onchange('field_1', 'field_2', 'field_3', 'field_4',
                  'field_6', 'field_7', 'field_8', 'field_9', 'field_10',
                  'field_11', 'field_12')
    def _onchange_street(self):
        if self.field_1 or self.field_2 or self.field_3 or self.field_4 or self.field_6 or \
           self.field_7 or self.field_8 or self.field_9 or self.field_10: 
            self.street = "%s %s  %s %s %s %s  %s %s %s" % (
