...
class SuggestReturnRequestLot(models.TransientModel):
    _name = "ht.suggest.return.request.lot"
    ...
    suggested_lot_id = fields.Many2one("ht.suggest.return.request.lot.line")
...
class SuggestReturnRequestLotLine(models.TransientModel):
    _name = "ht.suggest.return.request.lot.line"
    _description = "Suggest lots for the return request line"

    wizard_id = fields.Many2one(
        comodel_name="ht.suggest.return.request.lot",
        ondelete="cascade",
    )
