...
class ResConfigSettings(models.TransientModel):
    ...
    enable_sale_sync = fields.Boolean(string="Sincronizar pedidos", config_parameter='sync_odoo_xmlrpc.enable_purchase_sync')
    ...
    def set_values(self):
        ...
        config.set_param('sync_odoo_xmlrpc.remote_odoo_url', self.remote_odoo_url)
        config.set_param('sync_odoo_xmlrpc.remote_odoo_db', self.remote_odoo_db)
        config.set_param('sync_odoo_xmlrpc.remote_odoo_user', self.remote_odoo_user)
        config.set_param('sync_odoo_xmlrpc.remote_odoo_password', self.remote_odoo_password)

    def get_values(self):
        res = super().get_values()
        config = self.env['ir.config_parameter'].sudo()
        res.update({
            'remote_odoo_url': config.get_param('sync_odoo_xmlrpc.remote_odoo_url'),
            'remote_odoo_db': config.get_param('sync_odoo_xmlrpc.remote_odoo_db'),
            'remote_odoo_user': config.get_param('sync_odoo_xmlrpc.remote_odoo_user'),
            'remote_odoo_password': config.get_param('sync_odoo_xmlrpc.remote_odoo_password'),
        })
        return res
